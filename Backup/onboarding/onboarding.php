        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-10">
                <label class="relative border-2 ${selectedServiceKey === 'revocable_living_trust' ? 'border-primary' : 'border-slate-200 dark:border-slate-700'} rounded-2xl p-6 cursor-pointer hover:border-primary transition-all group h-full flex flex-col">
                    ...
                    <div class="flex items-center font-bold text-sm ${revocableIsFree ? 'text-green-600 dark:text-green-400' : 'text-primary'}">
                        <span class="material-icons-outlined text-lg mr-1.5">${revocableIsFree ? 'check_circle' : 'payments'}</span>
                        ${revocablePriceLabel}
                    </div>
                ...
                <label class="relative border-2 ${selectedServiceKey === 'irrevocable_trust' ? 'border-primary' : 'border-slate-200 dark:border-slate-700'} rounded-2xl p-6 cursor-pointer hover:border-primary transition-all group h-full flex flex-col">
                    ...
                    <div class="flex items-center font-bold text-sm ${irrevocableIsFree ? 'text-green-600 dark:text-green-400' : 'text-primary'}">
                        <span class="material-icons-outlined text-lg mr-1.5">${irrevocableIsFree ? 'check_circle' : 'payments'}</span>
                            ...
                            ` : (
                                paymentStage === 'details'
                                    ...
                                    : paymentStage === 'confirmed'
                                        ...
                                        : `
                                            <div class="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/30 p-5">
                                                <p class="font-bold text-slate-900 dark:text-white">Select a payment method</p>
                                ...
                                paymentStage === 'details'
                                    ...
                                    : paymentStage === 'confirmed'
                                        ...
                                        : `
                                            ...
                                            <button id="continueToPaymentDetailsBtn" onclick="goToPaymentDetails()" ${onboardingData.payment_method_id ? '' : 'disabled'} class="w-full bg-primary hover:opacity-90 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed">
