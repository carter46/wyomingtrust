<?php
$page_title = 'Terms of Service - WyomingTrust';
include 'includes/header.php';
?>

<?php
$hero_title = 'Terms of Service';
$hero_subtitle = 'The terms and conditions governing use of the WyomingTrust platform.';
$hero_label = 'Legal';
$hero_cta_text = '';
include 'includes/components/hero-primary.php';
?>
<section class="py-section-padding-lg px-gutter bg-warm-cream">
<div class="max-w-3xl mx-auto bg-surface-container-lowest rounded-2xl border border-outline-variant/30 p-8 md:p-12 shadow-sm">
...
<div class="space-y-8">
                <section>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                        By accessing and using WyomingTrust ("the Platform"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these Terms of Service, you may not use the Platform.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
                        WyomingTrust provides a digital platform for creating and managing trust services for cryptocurrency and digital assets. Our services include:
                    </p>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant mt-4 leading-relaxed">
                        <strong>Important Disclaimer:</strong> WyomingTrust is a technology platform and administrative service provider. We are not a bank, financial institution, or legal advisor. We do not provide investment, legal, or tax advice.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                        All content, features, and functionality of the Platform, including but not limited to text, graphics, logos, and software, are the exclusive property of WyomingTrust and are protected by international copyright, trademark, and other intellectual property laws.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed mb-4">
                        TO THE MAXIMUM EXTENT PERMITTED BY LAW, WYOMINGTRUST SHALL NOT BE LIABLE FOR:
                    </p>
                    <ul class="list-disc pl-6 space-y-2 font-body-md text-body-md text-on-surface-variant">
                ...
                <section>
                    ...
                    <div class="bg-surface-container-low rounded-xl p-6 border border-outline-variant/30">
                        <p class="font-body-md text-body-md text-on-surface-variant mb-2"><strong>WyomingTrust</strong></p>
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant">Website: <a href="contact_us.php" class="text-secondary font-bold hover:underline">Contact Us Page</a></p>
                    </div>
                </section>
</div>
</div>
