<?php
$page_title = 'Wyoming LLC | Register Your Business in Wyoming - WyomingTrust';
include 'includes/header.php';
?>

<!-- Trust Bar -->
<section class="py-4 sm:py-6 border-b border-outline-variant/30 bg-surface-container-lowest">
...
<div class="max-w-xl">
<span class="inline-block px-3 py-1 rounded-full bg-secondary-fixed text-on-secondary-fixed font-label-sm text-label-sm uppercase tracking-wider mb-4">Limited Liability, Limitless Potential<sup class="text-[10px]">℠</sup></span>
<h1 class="font-display-lg text-display-lg text-on-primary leading-tight mb-4 sm:mb-6">
Register Your Business in <span class="text-sky-accent">Wyoming</span>
</h1>
<p class="font-body-lg text-body-lg text-sky-accent mb-6 font-semibold">The Best State To Register Your Business</p>
...
<div class="text-xs font-medium uppercase tracking-widest opacity-80">Companies Formed</div>
</div>
</div>
...
<!-- Testimonials -->
<section class="py-section-padding-lg px-gutter bg-surface-container-low">
<div class="max-w-container-max mx-auto">
<h2 class="text-center font-headline-lg text-headline-lg text-primary mb-8 sm:mb-12">Hear Directly From Our Delighted Customers</h2>
<div class="grid md:grid-cols-2 gap-6 sm:gap-8">
<div class="bg-surface-container-lowest p-6 sm:p-8 rounded-2xl border border-outline-variant/30 shadow-sm hover:shadow-md transition-shadow">
...
<p class="font-body-md text-body-md italic text-on-surface-variant">"I have used Wyoming LLC for several years now and I love the fact that they have live customer service. They are always very helpful and professional. Their prices are also very inexpensive by comparison to others out there in this market space."</p>
</div>
</div>
</div>
</section>
...
<h2 class="font-headline-lg text-headline-lg mb-4 sm:mb-6">File Your LLC or Corporation for Just $250 + State Fees</h2>
<p class="text-on-primary-container text-lg mb-8">Every filing includes:</p>
</div>
...
<!-- 100,000+ Businesses + Annual Fees & Taxes -->
<section class="py-section-padding-lg px-gutter bg-warm-cream">
<div class="max-w-container-max mx-auto">
<div class="text-center mb-12">
<h2 class="font-display-lg text-display-lg text-primary mb-2">100,000+</h2>
<p class="font-body-lg text-body-lg text-on-surface-variant">Businesses Formed With Wyoming LLC Attorney</p>
</div>
<div class="grid md:grid-cols-2 gap-6 sm:gap-8">
...
<div class="max-w-container-max mx-auto">
<div class="text-center mb-12 sm:mb-16">
<h2 class="font-headline-lg text-headline-lg text-primary mb-2 pb-3 border-b-2 border-secondary inline-block">The Turn-Key LLC</h2>
<p class="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto mt-6">We provide everything you need to start your business with complete peace of mind. No hidden fees, no surprises – just professional, reliable service.</p>
</div>
<div class="bg-surface-container-lowest rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden border border-outline-variant/30">
<div class="p-6 sm:p-8 lg:p-10">
<h3 class="font-headline-md text-headline-md text-primary mb-2">Complete Business Formation Package</h3>
...
<div class="bg-primary text-on-primary p-6 sm:p-8 lg:p-10">
<h4 class="font-headline-md text-headline-md text-center mb-4">Our Professional Promise</h4>
<p class="text-on-primary-container text-center max-w-2xl mx-auto">Using our service ensures your personal information is protected with no risk of errors. We handle everything correctly the first time with no surprises, getting your business up and running in less than 24 hours.</p>
...
<div class="max-w-container-max mx-auto">
<div class="text-center mb-12 sm:mb-16">
<h2 class="font-headline-lg text-headline-lg text-primary mb-4">Wyoming LLC Benefits</h2>
<p class="font-body-md text-body-md text-on-surface-variant max-w-3xl mx-auto">Wyoming Limited Liability Companies offer the best combination of asset protection laws, privacy benefits, and cost savings. Perfect for online stores, real estate investors, and holding companies.</p>
</div>
...
<!-- FAQs -->
<section class="pt-section-padding-lg pb-0 px-gutter bg-surface">
<div class="max-w-3xl mx-auto text-center mb-4">
<h2 class="font-headline-lg text-headline-lg text-primary">FAQs</h2>
</div>
</section>
<?php
$faq_id = 'privacyFaqAccordion';
$faq_title = 'Privacy & Anonymity FAQs';
$faq_items = [
    [
        'question' => 'Are Wyoming LLCs private and anonymous?',
        'answer' => 'Wyoming is one of the best states for privacy. We do not list member or manager names on the public record, maintaining your confidentiality.',
    ],
    [
        'question' => 'Is my information entered into any public database with a Wyoming LLC?',
        'answer' => 'Only the necessary legal filing information is submitted. Your private ownership details remain securely with our registered agent service.',
    ],
    [
        'question' => 'Is it wrong to desire anonymity for my LLC?',
        'answer' => 'Not at all. Privacy is a legitimate business concern, and Wyoming\'s laws are designed to protect business owners\' privacy while maintaining compliance.',
    ],
    [
        'question' => 'Can I use my Wyoming LLC to own an LLC in another state?',
        'answer' => 'Yes, Wyoming LLCs are frequently used as "holding companies" for other entities, providing an extra layer of asset protection.',
    ],
    [
        'question' => 'Does this setup work in all states?',
        'answer' => 'Yes, Wyoming LLCs can operate in all 50 states and internationally. You can conduct business anywhere while maintaining the benefits of Wyoming\'s favorable laws.',
    ],
];
include 'includes/components/faq-accordion.php';

$faq_id = 'llcFaqAccordion';
$faq_title = 'Wyoming LLC Frequently Asked Questions';
$faq_items = [
    [
        'question' => 'Why use a Wyoming LLC?',
        'answer' => 'Wyoming offers the best combination of asset protection, privacy, low fees, and tax advantages. It\'s perfect for asset protection, real estate investment, and online businesses.',
    ],
    [
        'question' => 'How much does it cost to file an LLC in Wyoming?',
        'answer' => 'The state filing fee is $100. With our services, you get complete business formation starting at $250 plus state fees, with only a $60 annual report required each year.',
    ],
    [
        'question' => 'Are LLCs taxed in Wyoming?',
        'answer' => 'Wyoming has no state income tax, corporate tax, or franchise tax. LLCs can choose to be taxed as partnerships, corporations, or S-corporations.',
    ],
    [
        'question' => 'Can Wyoming LLC have an out-of-state address?',
        'answer' => 'Yes, you can use our Wyoming registered agent address for all business purposes while operating from anywhere in the world.',
    ],
];
include 'includes/components/faq-accordion.php';
?>
