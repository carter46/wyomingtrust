...
$features = [
    ...
    ['icon' => 'payments', 'title' => 'Tax Benefits', 'desc' => 'Significant estate and gift tax advantages'],
...
<?php
$benefits = [
    ['icon' => 'shield', 'title' => 'Creditor Protection', 'desc' => 'Assets are protected from creditors, lawsuits, and bankruptcy—they\'re no longer part of your personal estate.'],
    ['icon' => 'arrow-back', 'title' => 'Estate Tax Reduction', 'desc' => 'Remove appreciating crypto from your taxable estate, potentially saving millions in estate taxes.'],
    ['icon' => 'info', 'title' => 'Medicaid Eligibility', 'desc' => 'Properly structured trusts can help qualify for Medicaid while preserving wealth for beneficiaries.'],
    ['icon' => 'history', 'title' => 'Generation Planning', 'desc' => 'Create lasting wealth for multiple generations with precise distribution control.'],
    ...
    ['icon' => 'group', 'title' => 'Charitable Giving', 'desc' => 'Combine asset protection with philanthropy through charitable remainder trusts.'],
];
...
<?php echo wt_icon('phone', 'text-secondary'); ?>
